...
qualname_overrides = {
    ...
    "scanpy.plotting._matrixplot.MatrixPlot": "scanpy.plotting.MatrixPlot",
    "scanpy.plotting._dotplot.DotPlot": "scanpy.plotting.DotPlot",
    "scanpy.plotting._stacked_violin.StackedViolin": "scanpy.plotting.StackedViolin",
}

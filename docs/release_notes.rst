...
- :func:`~scanpy.pl.embedding_density` allows plot cell densities on embeddings, see `here <https://github.com/theislab/scanpy/pull/543>`__ :smaller:`thanks to M Luecken`

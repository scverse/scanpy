...
def mnn_correct(*datas, var_index=None, var_subset=None, batch_key='batch', index_unique='-',
    ...
    """Apply MNN correct to input data matrices or AnnData objects. 
    
    Correct batch effects by matching mutual nearest neighbors. Wrapped from the package mnnpy
    (https://github.com/chriscainx/mnnpy)

    Depending on do_concatenate, returns matrices or AnnData objects in the original order containing corrected 
    expression values, or concatenated matrices or AnnData object. Wrapped from mnnpy.
    ...
    try:
        ...
        datas, mnn_list_, angle_list_ = mnn_cor(*datas, var_index, var_subset, batch_key, index_unique,
        ...
        return datas, mnn_list_, angle_list_
    except ImportError:
        logg.warn('Please install the package mnnpy '
                  '(https://github.com/chriscainx/mnnpy). ')
        pass
    return None

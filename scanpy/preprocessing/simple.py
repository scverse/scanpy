...
def mnn_concatenate(*adatas, geneset=None, k=20, sigma=1, n_jobs = None, **kwargs):
    ...
    Returns
    -------
    An AnnData object with MNN corrected data matrix X.
    ...
    """
    adata = AnnData.concatenate(*adatas, **kwargs)
    if geneset is None:
    ...
    mnn_result = rscran.mnnCorrect(*datamats, BPPARAM = bpparam)

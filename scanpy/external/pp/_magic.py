...
def magic(
    ...
    **kwargs,
    ...
    """\
    Markov Affinity-based Graph Imputation of Cells (MAGIC) API [vanDijk2018]_.
    ...
    compared to the algorithm described in [vanDijk2018]_. Firstly, we use
    the adaptive kernel described in Moon et al, 2019 [Moon2017]_ for
    ...
    solver
        ...
        in van Dijk et al. (2018) [vanDijk2018]_. "approximate" uses a faster

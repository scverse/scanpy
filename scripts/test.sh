...
./scripts/scanpy.py moignard15 pca -ss 5 -s -r pp -v 0
...
./scripts/scanpy.py moignard15 dpt -q basis=tsne -ss 5 -s -r -v 0
# burczynski06
./scripts/scanpy.py burczynski06 diffrank -s -r pp -v 0
# paul15pca
./scripts/scanpy.py paul15pca dpt -ss 5 -s -r pp -v 0
./scripts/scanpy.py paul15pca diffrank -p smp=dpt_groups names='2,3' -ss 5 -s -r -v 0
# toggleswitch

...
class StackedViolin(BasePlot):
    ...
    def style(  # noqa: PLR0913
        self,
        *,
        cmap: Colormap | str | Default | None = Default("self.DEFAULT_COLORMAP"),
        ...
        linewidth: float | Default | None = Default("self.DEFAULT_LINE_WIDTH"),
        row_palette: str | Default | None = Default("self.DEFAULT_ROW_PALETTE"),
        ...
        ylim: tuple[float, float] | Default | None = Default("self.DEFAULT_YLIM"),

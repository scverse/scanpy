...
class DotPlot(BasePlot):
    ...
    def style(  # noqa: PLR0913
        self,
        *,
        cmap: Colormap | str | Default | None = Default("no change"),
        color_on: Literal["dot", "square"] | Default = Default("no change"),
        dot_max: float | Default | None = Default("no change"),
        dot_min: float | Default | None = Default("no change"),
        smallest_dot: float | Default = Default("no change"),
        largest_dot: float | Default = Default("no change"),
        dot_edge_color: ColorLike | Default | None = Default("no change"),
        dot_edge_lw: float | Default | None = Default("no change"),

...
def test_cluster_decision_tree_plot(adata_with_clusters, image_comparer):
    ...
    cluster_decision_tree(
        ...
        level_label_style={"level_label_offset": 15, "level_label_fontsize": 8},
        title_style={"title": "Hierarchical Leiden Clustering", "title_fontsize": 8},
        clustering_settings={"prefix": "leiden_res_"},
        layout_settings={"node_spacing": 5.0, "level_spacing": 1.5},
    )

    image_comparer(Path("tests/_images"), "cluster_decision_tree_plot", tol=100)
